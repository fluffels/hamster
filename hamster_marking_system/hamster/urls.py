...
urlpatterns = patterns('',
    ...
    url(r'courses/[A-Z]{3}[0-9]{3}/sessions/$','web_interface.views.getAllSessionsForAssessment', name='view_sessions'),
    ...
    url(r'view-assessment$','web_interface.views.getAllChildrenOfAssessment', name='view_children_assessment'),
