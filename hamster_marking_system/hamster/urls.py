...
urlpatterns = patterns('',
    ...
    url(r'[A-Za-z0-9 _]*[A-Za-z0-9][A-Za-z0-9 _]*$','web_interface.views.getAllChildrenOfAssessment', name='view_children_assessment'),
    ...
    url(r'[A-Za-z0-9 _]*[A-Za-z0-9][A-Za-z0-9 _]*$','web_interface.views.getAllChildrenOfAssessmentForStudent', name='view_children_assessment_student'),
